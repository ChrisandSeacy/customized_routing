...
main(int argc, char* argv[])
{
    ...
    uint32_t nWifi = 18;   //wifi node number
   ...
   //s0->s2 time delay:8, packet loss 6, throughtput 10
    ...
    pointToPoint4.SetChannelAttribute("Delay", StringValue("18ms"));
   ...
   //s2->s6 time delay:5, packet loss 8, throughtput 2
    ...
    echoClient.SetAttribute("MaxPackets", UintegerValue(800));
    ...
    echoClient2.SetAttribute("MaxPackets", UintegerValue(800));
    ...
    echoClient3.SetAttribute("MaxPackets", UintegerValue(800));
    ...
    echoClient4.SetAttribute("MaxPackets", UintegerValue(800));
